...
import { MsgLiquidStakeResponse, MsgRedeemStake } from '@agoric/cosmic-proto/stride/stakeibc/tx.js';
...
import { protoMsgMocks } from '../../../boot/tools/ibc/mocks.js';
...
test('Happy Return Flow: input stAtom at agoric receives atom on cosmoshub', async t => {
  ...
  await t.notThrowsAsync(
    deposit(
      { amount: '10', denom: 'ibc/92287A0B6A572CDB384B6CD0FE396DFE23F5C2E02801E9562659DACCFD74941E' },
      'channel-12696',
